...
# Creates a user specific test bed
	def createTestBed( self, argumentMap = None ):
		...
		if( argumentMap.__contains__( "testBedPath" ) != True ):
			testBedPath = os.path.join( os.getcwd(), "testData" )
			self.__createTestDirectory( os.getcwd(), "testData" )
		else:
			testBedPath = os.path.join( argumentMap[ "testBedPath" ], "testData" )
			self.__createTestDirectory( argumentMap[ "testBedPath" ], "testData" )
